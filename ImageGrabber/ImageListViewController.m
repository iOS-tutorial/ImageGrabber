...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(imageUpdated:) name:@"com.bipin.imageUpdated" object:nil];
...
- (void)viewDidUnload
{
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"com.bipin.imageUpdated" object:nil];
